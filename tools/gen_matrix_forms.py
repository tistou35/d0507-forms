...
#
#   python3 tools/gen_matrix_forms.py          # เขียน EFM · EFC
#
# ใบพวกนี้มีหัวข้อประเมินรวมกันเกือบ 150 ข้อ ถ้าพิมพ์เองจะตกหล่นแน่
...
# ── SEF ────────────────────────────────────────────────────
# ไม่ได้ใช้แล้ว — SEF ทำผ่านระบบบันทึกการฝึก (d0507.361vision.org) ส่งตรงถึงศิษย์
# เก็บโค้ดไว้เผื่อย้อนกลับ ถ้าจะเปิดใช้อีกให้ใส่ sef กลับเข้าลูปท้ายไฟล์
def sef():
    secs = [{
